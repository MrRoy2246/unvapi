...
GET_SESSION_URL = f"{IPC_BASE_URL}/LAPI/V1.0/Channels/0/Media/Video/Streams/Sessions"
# Device credentials
USERNAME = "admin"  
...
def get_session():
    ...
    try:
        response = requests.get(GET_SESSION_URL, headers=headers, auth=HTTPDigestAuth(USERNAME, PASSWORD), timeout=10)
